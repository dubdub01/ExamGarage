...
addImage.addEventListener('click',()=>{
    ...
    const voitureImages = document.querySelector('#voiture_images')

    //recup le prototype des entrées data-prototype
    const prototype = voitureImages.dataset.prototype.replace(/__name__/g, index) // drapeau g pour indiquer que l'on va le faire plusieurs fois 
